...
export function AcceptRuleCandidate(arg1) {
  return window['go']['main']['App']['AcceptRuleCandidate'](arg1);
}
...
export function RejectRuleCandidate(arg1) {
  return window['go']['main']['App']['RejectRuleCandidate'](arg1);
}
