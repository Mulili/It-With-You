...
var directiveHints = []string{
	...
	// 行为要求
	"我希望你", "希望你", "你应该", "你要", "尽量",
	// 偏好表达：比上面的"要求"更口语，字面上不像命令，但说的仍是长期倾向。
	// 「我喜欢你多笑」「她要是能温柔点就好了」都是这一类——早年这份清单漏了它们，
	// 于是用户**明说**的话粗筛不过，被当成"她自己观察到的"绕道落进了候选区，
	// 变成一件要用户点头才生效的事。这正是"宁滥勿缺"要防的那种错。
	"我喜欢", "我不喜欢", "喜欢你", "能不能", "可以不可以",
	// 抱怨式要求：「你别老是这么凶」——通篇没有"要求"字样，意图却是长期改变
	"别老是", "不要老是", "老是",
	// 风格
